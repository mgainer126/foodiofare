      ...
      <div className="about__container">
        <div className="about">
          ...
          <p className="about__para">
            ...
            favorite food vendor is today. FoodioFare is meant to bridge that
            gap by proving the ability for vendors to easily update their
            location so that the can be found by hungry customers.
          </p>
          <p className="about__para">
